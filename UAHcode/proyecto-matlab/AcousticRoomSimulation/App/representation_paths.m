                ...
                if h == 1
                    ...
                    if api == 1
                        ...
                        path1=[S(1,1) S(1,2) S(1,3) full(x(2)) full(y(2)) full(z(2)) R(1,1) R(1,2) R(1,3)];
                            ...
                            %path1(1:3)=[full(x(1)) full(y(1)) full(z(1))];
                        end
                    else
                        plot3(x(index(1,:)),y(index(1,:)),z(index(1,:)),colors(c));
                        hold on;
...
%             midpoint1_2coor=midpoint+vector2.*separacion_point_edges;
...
%             midpoint1_1=midpoint1_1coor;
%             midpoint1_2=midpoint1_2coor;
...
%            while (sum(midpoint1_1(r-1,:) <  corners(edgecorners(diffedge,1),:)) == 0 )  || (sum(midpoint1_2(r-1,:) >  corners(edgecorners(diffedge,2),:)) == 0)
             while sum(abs(long_edge/2) > abs(midpoint-midpoint1_1coor ))
