...
global JJ JJnumbofchars SUPPRESSFILES
...
% if setupfiletype == 1
if api == 1
setupmatfile = EDB2readsetup(cadgeofile,api,infos);
else 
    setupmatfile = EDB2readsetup(cadgeofile,api);
end
...
% DIBUJA:
% reflpathsfile='C:\Users\Ruth\Documents\borrar\ty_1_1_edpaths';
% plotoptions=11;
% figure
