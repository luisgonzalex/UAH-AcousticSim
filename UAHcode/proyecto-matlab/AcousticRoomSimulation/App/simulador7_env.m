function varargout = simulador7_env(varargin)
% SIMULADOR7_ENV MATLAB code for simulador7_env.fig
...
% Use functions:
        ...
        % resultados.txt: resultados de la simulación generados en simulador3_env en la llamada a EDB2main
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @simulador7_env_OpeningFcn, ...
                   'gui_OutputFcn',  @simulador7_env_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before simulador7_env is made visible.
function simulador7_env_OpeningFcn(hObject, eventdata, handles, varargin)
...
%handles.autoescalado=0;

% Choose default command line output for simulador7_env
...
function varargout = simulador7_env_OutputFcn(hObject, eventdata, handles) 
...
% load('info.mat')
%     plot_receive=num2str(plot_receive);
