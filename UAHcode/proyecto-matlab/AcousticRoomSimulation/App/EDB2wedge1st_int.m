function [ir,initdelay,singularterm] = EDB2wedge1st_int(fs,closwedang,rs,thetas,zs,rr,thetar,zr,zw,Method,R_irstart,bc)
% EDB2wedge1st_int - Gives the 1st order diffraction impulse response.
...
%
% Uses the functions EDB2quadstep and EDB2betaoverml for numerical integration.
%
% ----------------------------------------------------------------------------------------------
...
%
% [ir,initdelay,singularterm] = EDB2wedge1st_int(fs,closwedang,rs,thetas,zs,rr,thetar,zr,zw,Method,R_irstart,bc);
