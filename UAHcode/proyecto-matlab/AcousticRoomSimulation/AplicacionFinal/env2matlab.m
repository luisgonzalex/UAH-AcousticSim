function env2matlab(ruta,envfile)
% Convierte archivos .ENV/.SRF a una estructura de Matlab, guardando esta y
% algunos parámetros más en el archivo data_struct.mat:
% numsurfaces: almacena el número de superficies que definen la geometría
% surfaces: se trata de una estructura de Matlab donde se guarda la información de cada superficie, indicando las coordenadas de cada vértice y algunos parámetros más.
% comment,content,version,dirEnvironments: contienen otra información disponible en .ENV
...
save data_struct numsurfaces comment content version dirEnvironments surfaces
