...
if plotsources
    sdatafile = [eddatafilepath,filesep,Filestem,'_sdata.mat']; %filesep añadido por mi
...
if plotreceivers
    rdatafile = [eddatafilepath,filesep,Filestem,'_rdata.mat'];  %filesep añadido por mi
