function Q = EDB2quadstep(a,b,fa,fc,fb,tol,rs,rr,zs,zr,ny,sinnyfivec,cosnyfivec)
% EDB2quadstep - Recursive numerical integration routine for EDB2wedge1st_int.
% Modified from Matlabs QUADSTEP function. The EDB2quadstep version
...
% ----------------------------------------------------------------------------------------------
% Peter Svensson (svensson@iet.ntnu.no) 20040321
%
% EDB2quadstep(a,b,fa,fc,fb,tol,rs,rr,zs,zr,ny,sinnyfivec,cosnyfivec)
...
% Subdivide into two subintervals.
   ...
   Qac = EDB2quadstep(a(tempvec),c(tempvec),fa(tempvec),fd(tempvec),fc(tempvec),tol,rs,rr,zs,zr,ny,sinnyfivec,cosnyfivec);
   Qcb = EDB2quadstep(c(tempvec),b(tempvec),fc(tempvec),fe(tempvec),fb(tempvec),tol,rs,rr,zs,zr,ny,sinnyfivec,cosnyfivec);
   Q(tempvec) = Qac + Qcb;
end
