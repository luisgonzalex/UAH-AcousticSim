function [hitvec,edgehit,cornerhit] = EDB2poinplax(bigplanelist,xpoints,planelist,minvals,maxvals,planecorners,corners,ncornersperplanevec,planenvecs)
...
% ----------------------------------------------------------------------------------------------
% Peter Svensson (svensson@iet.ntnu.no) 20100204
% 
% [hitvec,edgehit] = EDB2poinplax(bigplanelist,xpoints,planelist,minvals,maxvals,planecorners,corners,ncornersperplanevec,planenvecs);
...
edgehit   = uint32(zeros(nposs,1));
cornerhit = uint32(zeros(nposs,1));
